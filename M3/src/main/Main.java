...
public class Main {
	public static void main(String[] args) {
		...
		while (true) {
			System.out.println("prees enter: ");
			sc.nextLine();
			try {
		...
		luchadores.add(usuario.getWarrior());
		...
		while (true) {
			...
			// si el usuario escoge un luchador incompatible con el arma que porta genera un error
			// para que esto funcione asi, se tendra que comprobar que usuario.getWeapon()==null.
